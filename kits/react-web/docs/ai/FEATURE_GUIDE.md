...
## Entrega de features — checklist de produção
...
- **escopo**: declarar regra, exceção permitida e evidência esperada.
- **fatiamento**: declarar regra, exceção permitida e evidência esperada.
- **flags**: declarar regra, exceção permitida e evidência esperada.
- **aceite**: declarar regra, exceção permitida e evidência esperada.
- **riscos**: declarar regra, exceção permitida e evidência esperada.
