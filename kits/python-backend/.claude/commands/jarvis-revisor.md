...
2. `product_roles/role-backend-architect.md`, sempre
...
- Camada de serviço chamando ORM direto da view/controller.
- Model/database vazando para a camada de apresentação (serializer incompleto).
...
## Parecer Arquitetura Backend

- [OK/PENDÊNCIA] Camadas — ...
- [OK/PENDÊNCIA] Dependência — ...
- [OK/PENDÊNCIA] Serializers — ...
- [OK/PENDÊNCIA] Nomenclatura — ...
- [OK/PENDÊNCIA] Services — ...
