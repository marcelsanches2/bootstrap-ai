...
## Regras específicas Python backend

Validar especialmente:

- separação API/service/domain/data
- contratos HTTP e schemas
- migrations Alembic quando houver schema
- rollback/downgrade quando aplicável
- transações e idempotência
- auth/autorização
- logs sem dados sensíveis
- `ruff`, `mypy`, `pytest`
- healthcheck e observabilidade quando houver deploy
