...
```
Do you have a technical stack preference? Any constraints (deadline, budget, need to integrate with something specific)?
```
...
2. **"I want it created"** → `/design-phase` will generate a design system from scratch
