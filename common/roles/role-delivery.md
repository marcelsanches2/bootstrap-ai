...
Revisar qualquer plano técnico sob a perspectiva de deploy, rollback, migrações, feature flags e riscos operacionais. Este papel é genérico e serve como base para kits que ainda não têm role específico.
