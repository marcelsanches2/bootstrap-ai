...
1. **ONE question at a time. Wait for an answer before continuing. Your response must be ONLY the question — no preamble.**
...
- **Challenge vague terms**: "You said 'account' — does that mean Customer or User? They're different things."
...
Suggested next step: `/jarvis-plan`
