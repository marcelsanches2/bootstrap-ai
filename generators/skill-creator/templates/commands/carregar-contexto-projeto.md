...
---|---
Arquitetura, estrutura, DI, router | `CLAUDE.md`, `docs/ai/ARCHITECTURE*`
Codigo, refatoracao, review | `CLAUDE.md`, `docs/ai/CODING*`
...
```
Contexto: CLAUDE.md + N docs + N skills | Projeto: <nome-do-repo>
```
