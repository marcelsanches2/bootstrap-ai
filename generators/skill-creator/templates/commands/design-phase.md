...
| --color-primary-hover | [hex] | Hover on primary actions |
...
- Components must follow the documented variants
...
- Do not invent color/typography values if you have Figma — use what came from it
